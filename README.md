...
Building (and running) is continuously tested under Linux (Ubuntu 20.04) using gcc-9.3, gcc-10 and clang-11, MacOS (Mojave 10.15) using AppleClang and gcc-10, and Windows using MSVC 15.9. 
