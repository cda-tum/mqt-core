...
TEST_F(QFRFunctionality, ImportQasm3OldSyntax) {
  std::stringstream ss{};
  const std::string testfile = "OPENQASM 3.0;\n"
                               "include \"stdgates.inc\";\n"
                               "qreg q[3];\n"
...
TEST_F(QFRFunctionality, ImportQasm3GateDecl) {
  std::stringstream ss{};
  const std::string testfile = "OPENQASM 3.0;\n"
                               "include \"stdgates.inc\";\n"
                               "qubit[2] q;\n"
...
TEST_F(QFRFunctionality, ImportQasm3CtrlModifier) {
  std::stringstream ss{};
  const std::string testfile = "OPENQASM 3.0;\n"
                               "include \"stdgates.inc\";\n"
                               "qubit[3] q;\n"
...
TEST_F(QFRFunctionality, ImportQasm3InvModifier) {
  std::stringstream ss{};
  const std::string testfile = "OPENQASM 3.0;\n"
                               "include \"stdgates.inc\";\n"
                               "qubit[1] q;\n"
...
TEST_F(QFRFunctionality, ImportQasm3CompoundGate) {
  std::stringstream ss{};
  const std::string testfile = "OPENQASM 3.0;\n"
                               "include \"stdgates.inc\";\n"
                               "qubit q;\n"
...
TEST_F(QFRFunctionality, ImportQasm3ControlledCompoundGate) {
  std::stringstream ss{};
  const std::string testfile = "OPENQASM 3.0;\n"
                               "include \"stdgates.inc\";\n"
                               "qubit[2] q;\n"
...
TEST_F(QFRFunctionality, ImportQasm3ParamCompoundGate) {
  std::stringstream ss{};
  const std::string testfile = "OPENQASM 3.0;\n"
                               "include \"stdgates.inc\";\n"
                               "qubit[2] q;\n"
...
TEST_F(QFRFunctionality, ImportQasm3Measure) {
  std::stringstream ss{};
  const std::string testfile = "OPENQASM 3.0;\n"
                               "include \"stdgates.inc\";\n"
                               "qubit[2] q;\n"
...
TEST_F(QFRFunctionality, ImportQasm3InitialLayout) {
  std::stringstream ss{};
...
TEST_F(QFRFunctionality, ImportQasm3ConstEval) {
  std::stringstream ss{};
...
TEST_F(QFRFunctionality, ImportQasm3NonUnitary) {
  std::stringstream ss{};
  const std::string testfile = "OPENQASM 3.0;\n"
                               "include \"stdgates.inc\";\n"
                               "qubit[2] q1;\n"
