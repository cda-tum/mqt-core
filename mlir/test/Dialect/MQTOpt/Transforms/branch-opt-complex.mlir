...
module {
  func.func @main() {
    ...
    cf.cond_br %c0_0, ^then(%q1_4 : !mqtopt.Qubit), ^continue(%q1_4 : !mqtopt.Qubit)

  ^then(%q1_4then : !mqtopt.Qubit):
    %q1_5 = mqtopt.x() %q1_4then : !mqtopt.Qubit
  ...
  ^continue(%q1_9 : !mqtopt.Qubit):
    ...
    %reg_4 = "mqtopt.insertQubit"(%reg_3, %q1_9) <{index_attr = 1 : i64}> : (!mqtopt.QubitRegister, !mqtopt.Qubit) -> !mqtopt.QubitRegister
