...
module {
    func.func @bell() -> (!mqtopt.QubitRegister, i1, i1) {
        ...
        %q0_1 = "mqtopt.x"(%q0_0) : (!mqtopt.Qubit) -> !mqtopt.Qubit
        %q1_1 = "mqtopt.x"(%q1_0) : (!mqtopt.Qubit) -> !mqtopt.Qubit

        %q0_2, %q1_2 = "mqtopt.x"(%q0_1, %q1_1) : (!mqtopt.Qubit, !mqtopt.Qubit) -> (!mqtopt.Qubit, !mqtopt.Qubit)

        %q1_3 = "mqtopt.x"(%q1_2) : (!mqtopt.Qubit) -> !mqtopt.Qubit
