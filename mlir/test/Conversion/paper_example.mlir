...
module {
    ...
    func.func @bar() {
        ...
        %out_qubits_0:2 = quantum.custom "CNOT"() %1, %out_qubits#0 : !quantum.bit, !quantum.bit
        %out_qubits_1:2 = quantum.custom "CNOT"() %out_qubits_0#1, %out_qubits#1 : !quantum.bit, !quantum.bit
        %out_qubits_2:2 = quantum.custom "CNOT"() %out_qubits_0#0, %out_qubits_1#1 : !quantum.bit, !quantum.bit
