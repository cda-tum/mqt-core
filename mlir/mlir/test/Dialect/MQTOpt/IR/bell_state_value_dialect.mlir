...
module {
    ...
    func.func @bell_state() -> (i1, i1) {
        ...
        %out_qubit_2 = mqtopt.x() %out_qubit : (!mqtopt.Qubit) -> !mqtopt.Qubit
        %out_qubit_3, %ctrl_out_qubits = mqtopt.x() %out_qubit_2 ctrl(%out_qubit_1) : (!mqtopt.Qubit, !mqtopt.Qubit) -> !mqtopt.Qubit, !mqtopt.Qubit
