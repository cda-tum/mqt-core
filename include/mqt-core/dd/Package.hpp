...
public:
  ...
  //      GateMatrix measurementMatrix = measureZero ? MEAS_ZERO_MAT :
  //      MEAS_ONE_MAT; const auto measurementGate =
  //      makeGateDD(measurementMatrix, nqubits, index); return measurementGate;
  //  }
