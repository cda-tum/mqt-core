...
class Operation:
    ...
    @controls.setter
    def controls(self, arg: set[Control]) -> None: ...
    def empty(self) -> bool: ...
    ...
    @targets.setter
    def targets(self, arg: list[int]) -> None: ...
    @property
    def gate(self) -> OpType: ...
    @gate.setter
    def gate(self, arg: OpType) -> None: ...
...
class CompoundOperation(Operation):
    ...
    @gate.setter
    def gate(self, arg: OpType) -> None: ...
    def to_open_qasm(self, qreg: list[tuple[str, str]], creg: list[tuple[str, str]], /) -> str: ...
...
class StandardOperation(Operation):
    ...
    def controls(self) -> set[Control]: ...
    @controls.setter
    def controls(self, value: set[Control]) -> None: ...
    @overload
    def equals(self, arg0: Operation, arg1: Permutation, arg2: Permutation, /) -> bool: ...
    @overload
...
class QuantumComputation:
    ...
    @gphase.setter
    def gphase(self, arg: float) -> None: ...
    @overload
    ...
    def add_classical_bit_register(self, nc: int, reg_name: str) -> None: ...
    def add_ancillary_register(self, nc: int, reg_name: str) -> None: ...
...
class Control:
    ...
    @control_type.setter
    def control_type(self, value: ControlType) -> None: ...
    @property
    def qubit(self) -> int: ...
    @qubit.setter
