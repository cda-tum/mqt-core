...
namespace qc {
    ...
    void QuantumComputation::addVariables(const SymbolOrNumber& expr) {
    ...
    void QuantumComputation::addVariables(const SymbolOrNumber& expr1, const SymbolOrNumber& expr2) {
        addVariables(expr1);
        addVariables(expr2);
    }
    void QuantumComputation::addVariables(const SymbolOrNumber& expr1, const SymbolOrNumber& expr2, const SymbolOrNumber& expr3) {
        addVariables(expr1);
        addVariables(expr2);
        addVariables(expr3);
    }
    ...
    // QuantumComputation QuantumComputation::getInstantiatedComputation(const VariableAssignment& assignment) const {
