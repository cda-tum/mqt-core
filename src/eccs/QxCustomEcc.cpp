 ...
 * >>then q = p+a and c=m.
 */
QxCustomEcc::QxCustomEcc(qc::QuantumComputation& qc, int measureFq, bool decomposeMC, bool cliffOnly): Ecc({ID::QxCustom, /*q*/-1, /*c*/-1, QxCustomEcc::getName()}, qc, measureFq, decomposeMC, cliffOnly) {}
