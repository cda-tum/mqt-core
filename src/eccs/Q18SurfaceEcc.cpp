...
Q18SurfaceEcc::Q18SurfaceEcc(qc::QuantumComputation& qc, int measureFq, bool decomposeMC, bool cliffOnly): Ecc({ID::Q18Surface, 36, 8, Q18SurfaceEcc::getName()}, qc, measureFq, decomposeMC, cliffOnly) {}
