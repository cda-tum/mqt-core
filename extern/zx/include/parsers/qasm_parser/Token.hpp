#ifndef JKQZX_INCLUDE_PARSERS_QASM_PARSER_TOKEN_HPP_
#define JKQZX_INCLUDE_PARSERS_QASM_PARSER_TOKEN_HPP_
...
#endif /* JKQZX_INCLUDE_PARSERS_QASM_PARSER_TOKEN_HPP_ */
