...
TEST_F(ZXDiagramTest, parse_qasm) {
  ...
  EXPECT_EQ(diag.getEdge(0, 2).value().type, zx::EdgeType::Hadamard);
  EXPECT_EQ(diag.getEdge(3, 4).value().type, zx::EdgeType::Simple);
  EXPECT_EQ(diag.getEdge(1, 4).value().type, zx::EdgeType::Simple);
  EXPECT_EQ(diag.getEdge(6, 4).value().type, zx::EdgeType::Simple);
  EXPECT_EQ(diag.getEdge(2, 3).value().type, zx::EdgeType::Simple);
  EXPECT_EQ(diag.getEdge(3, 5).value().type, zx::EdgeType::Simple);
  ...
  EXPECT_EQ(diag.getVData(5).value().type, zx::VertexType::Boundary);
  EXPECT_EQ(diag.getVData(6).value().type, zx::VertexType::Boundary);
...
TEST_F(ZXDiagramTest, deletions) {
  ...
  EXPECT_FALSE(diag.getVData(3).has_value());
...
TEST_F(ZXDiagramTest, graph_like) {
  ...
  EXPECT_EQ(diag.getEdge(0, 2).value().type, zx::EdgeType::Hadamard);
  EXPECT_EQ(diag.getEdge(3, 4).value().type, zx::EdgeType::Hadamard);
  EXPECT_EQ(diag.getEdge(1, 4).value().type, zx::EdgeType::Hadamard);
  EXPECT_EQ(diag.getEdge(6, 4).value().type, zx::EdgeType::Hadamard);
  EXPECT_EQ(diag.getEdge(2, 3).value().type, zx::EdgeType::Simple);
  EXPECT_EQ(diag.getEdge(3, 5).value().type, zx::EdgeType::Simple);
...
TEST_F(ZXDiagramTest, concat) {
  ...
  EXPECT_EQ(diag.getEdge(1, 4).value().type, zx::EdgeType::Simple);
  EXPECT_EQ(diag.getEdge(2, 3).value().type, zx::EdgeType::Simple);
  EXPECT_EQ(diag.getEdge(3, 7).value().type, zx::EdgeType::Hadamard);
  ...
  EXPECT_TRUE(diag.isDeleted(5));
  EXPECT_TRUE(diag.isDeleted(6));
}
...
TEST_F(SimplifyTest, spider_fusion) {
  ...
  for (zx::Vertex v = 2; v < diag.getNVertices(); v++)
    diag.addPhase(v, zx::Expression(zx::PyRational(1, 1)));
...
TEST_F(SimplifyTest, localComp) {
  ...
  diag.addVertex(0, 0, zx::PyRational(1, 2), zx::VertexType::Z); // 4
  diag.addVertex(0, 0, zx::PyRational(0, 1), zx::VertexType::Z); // 5
  diag.addVertex(0, 0, zx::PyRational(0, 1), zx::VertexType::Z); // 6
  diag.addVertex(0, 0, zx::PyRational(0, 1), zx::VertexType::Z); // 7
  diag.addVertex(0, 0, zx::PyRational(0, 1), zx::VertexType::Z); // 8
...
TEST_F(SimplifyTest, pivotPauli) {
  ...
  diag.addVertex(0, 0, zx::PyRational(1, 1), zx::VertexType::Z); // 4
  diag.addVertex(0, 0, zx::PyRational(0, 1), zx::VertexType::Z); // 5
  diag.addVertex(0, 0, zx::PyRational(0, 1), zx::VertexType::Z); // 6
  diag.addVertex(1, 0, zx::PyRational(0, 1), zx::VertexType::Z); // 7
  diag.addVertex(0, 0, zx::PyRational(0, 1), zx::VertexType::Z); // 8
  diag.addVertex(1, 0, zx::PyRational(0, 1), zx::VertexType::Z); // 9
  diag.addVertex(1, 0, zx::PyRational(0, 1), zx::VertexType::Z); // 10
...
TEST_F(SimplifyTest, interior_clifford_2) {
  ...
  diag.addVertex(0, 0, zx::PyRational(-1, 2), zx::VertexType::X); // 2
  diag.addVertex(0, 0, zx::PyRational(1, 2), zx::VertexType::Z);  // 3
  diag.addVertex(0, 0, zx::PyRational(-1, 2), zx::VertexType::X); // 4
...
TEST_F(SimplifyTest, non_pauli_pivot) {
  ...
  diag.addVertex(0, 0, zx::PyRational(1, 4)); // 2
  diag.addVertex(0);                          // 3
  diag.addVertex(0);                          // 4
...
TEST_F(SimplifyTest, clifford_3) {
  ...
  diag.addVertex(0);
  diag.addVertex(0, 0, zx::PyRational(0, 1), zx::VertexType::X);

  diag.addVertex(0);
  diag.addVertex(1, 0, zx::PyRational(0, 1), zx::VertexType::X);
...
TEST_F(SimplifyTest, gadgetSimp) {
  ...
  diag.addVertex(0);                          // 3
  diag.addVertex(0);                          // 4
  diag.addVertex(0, 0, zx::PyRational(1, 1)); // 5
  diag.addVertex(0);                          // 6
  diag.addVertex(0, 0, zx::PyRational(1, 1)); // 7
...
TEST_F(SimplifyTest, gadgetSimp_2) {
  ...
  diag.addVertex(0);                          // 2
  diag.addVertex(0);                          // 3
  diag.addVertex(0, 0, zx::PyRational(1, 1)); // 4
  diag.addVertex(0);                          // 5
  diag.addVertex(0, 0, zx::PyRational(1, 1)); // 6
...
TEST_F(SimplifyTest, fullReduce_2) {
  ...
  diag.addVertex(0, 0, zx::PyRational(1, 32), zx::VertexType::X);  // 4
  diag.addVertex(0, 0, zx::PyRational(0, 1), zx::VertexType::Z);   // 5
  diag.addVertex(1, 0, zx::PyRational(0, 1), zx::VertexType::X);   // 6
  diag.addVertex(0, 0, zx::PyRational(0, 1), zx::VertexType::Z);   // 7
  diag.addVertex(1, 0, zx::PyRational(0, 1), zx::VertexType::X);   // 8
  diag.addVertex(0, 0, zx::PyRational(-1, 32), zx::VertexType::X); // 9
...
TEST_F(ExpressionTest, basic_ops_1) {
  ...
  EXPECT_EQ(zx::PyRational(0, 1), e.getConst());
...
TEST_F(ExpressionTest, basic_ops_2) {
  ...
  EXPECT_EQ(sum.getConst(), zx::PyRational(0, 1));
}
